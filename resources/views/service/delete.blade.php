...
@section('title')
    In Out | Confirmation de la suppression
@endsection
...
<main class="col-7 offset-1">
        <div class="card col-12 ">
            ...
            Suppression Réussie !
                ...
                <div class="card-body">
                <h5 class="card-title text-success">Suppression de service</h5>
                <p class="card-text">Le service a été supprimé avec succès.</p>
